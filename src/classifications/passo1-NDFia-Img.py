...
params = {
    'assets':{
        ...
        'outputAsset': 'projects/nexgenmap/MapBiomas2/LANDSAT/mosaics-harmonico',     
    ...
    'lsPath' : ['214','215','216','217','218','219','220'],  #
    'bnd' : {
...
arqtoSaved = 0
cont = 3
for wrsP in params['lsPath']:   #

    print( 'WRS_PATH # ' + str(wrsP))
    for wrsR in params['lsGrade'][wrsP]:   #
        ...
        for index, ano in enumerate(lsAnos):
            ...
            myreg = wrsP + '_' + wrsR + '_' + str(ano)

            if myreg not in tilesAnosFeitos or ano > 2017:
                ...
                if index < 3 or janFeita == False:
                    ...
                    for oAno in lsWindowYear[index]:                                        
                        ...
                        print("==ano : {}  quantidade da Col {}".format(oAno, colSize))
                        if colSize > 0:
                ...
                try:
                    ...
                    if sizeColAtual > 0:
                        ...
                        name = 'fitted_image_' + str(ano) + '_' + wrsP + '_' + wrsR
                ...
                if janFeita == False:
                    anoInicial = ano
                    print("======  ANOA INITIAL NOW IS : {}  =======".format(anoInicial))
