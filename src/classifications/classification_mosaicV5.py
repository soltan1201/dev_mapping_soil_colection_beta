...
mapsSoilsV3 = ee.ImageCollection(params['inputAsset']);
...
for wrsP in params['lsPath'][biome_act][:]:   #    
    ...
    for wrsR in params['lsGrade'][biome_act][wrsP][:]:   #
        ...
        # coleta de pixels 
        # https://code.earthengine.google.com/3fc6bf46757d4c327f313d9421529338
        for index, ano in enumerate(lsAnos):            
            ...
            if sizeROIs > 0:
                ...
                try:
                    ...
                    mapsSoilsV3YY = mapsSoilsV3.filter(ee.Filter.eq('WRS_PATH', wrsP))
                    ...
                    if len(numberBands) > 1:
                        ...
                        classifiedGTB = mosaic.updateMask(mapsSoilsV3YY).classify(classifierGTB, 'classification_' + str(ano))                
