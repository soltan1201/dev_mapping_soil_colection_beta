...
var trueColor432Vis = {
  ...
  var params = {
        ...
        "layer_soil_predict": 'projects/nexgenmap/MapBiomas2/LANDSAT/DEGRADACAO/LAYER_SOILV5/classSoil_reg_21_2010_1_v5',
...
var lstBNDSoil = [
    'Caatinga_2009_classification_2009', 
    'Caatinga_2010_classification_2010', 
    'Caatinga_2011_classification_2011'
];
...
var layer_soil_pred = ee.Image(params.layer_soil_predict)
...
Map.addLayer(layer_soil_pred, {min:0 , max: 1}, 'maps Soil predict');